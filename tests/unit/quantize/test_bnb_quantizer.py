...
class TestBitsAndBytesQuantization:
    ...
    @patch('oumi.quantize.bnb_quantizer.AutoModelForCausalLM')
    @patch('transformers.BitsAndBytesConfig')
    def test_quantize_with_trust_remote_code(self, mock_bnb_config, mock_model, mock_tokenizer):
    ...
    @patch('oumi.quantize.bnb_quantizer.AutoModelForCausalLM')
    @patch('transformers.BitsAndBytesConfig')
    def test_quantize_model_loading_failure(self, mock_bnb_config, mock_model, mock_tokenizer):
    ...
    @patch('oumi.quantize.bnb_quantizer.AutoModelForCausalLM')
    @patch('transformers.BitsAndBytesConfig')
    def test_quantize_tokenizer_loading_failure(self, mock_bnb_config, mock_model, mock_tokenizer):
