...
class LittleNeuralNetwork(torch.nn.Module):
    def __init__(self):
        ...
        self.linear_relu_stack.add_module("linearA", torch.nn.Linear(14 * 14, 64))
        self.linear_relu_stack.add_module("reluA", torch.nn.ReLU())
        self.linear_relu_stack.add_module("linearB", torch.nn.Linear(64, 32))
        self.linear_relu_stack.add_module("reluB", torch.nn.ReLU())
        self.linear_relu_stack.add_module("linearC", torch.nn.Linear(32, 10))
