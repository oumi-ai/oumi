...
class TestQuantizerBuilders:
    ...
    def test_build_quantizer_awq_method(self):
        ...
        with patch("oumi.quantize.awq_quantizer.AwqQuantization") as mock_awq:
            mock_instance = Mock()
            mock_awq.return_value = mock_instance

            result = build_quantizer("awq_q4_0")
    ...
    def test_get_available_methods(self, mock_bnb, mock_awq):
        ...
        mock_awq.supported_methods = ["awq_q4_0", "awq_q4_1", "awq_q8_0", "awq_f16"]
        mock_bnb.supported_methods = ["bnb_4bit", "bnb_8bit"]

        result = get_available_methods()

        expected = {
            "AWQ": ["awq_q4_0", "awq_q4_1", "awq_q8_0", "awq_f16"],
    ...
    def test_get_supported_formats(self, mock_bnb, mock_awq):
        ...
        mock_awq.supported_formats = ["pytorch"]
        mock_bnb.supported_formats = ["pytorch", "safetensors"]
    ...
    def test_list_all_methods(self, mock_get_methods):
        ...
        expected = ["awq_q4_0", "awq_q4_1", "bnb_4bit", "bnb_8bit"]
    ...
    def test_build_quantizer_multiple_calls_create_new_instances(
        ...
        result1 = build_quantizer("awq_q4_0")
        result2 = build_quantizer("awq_q4_0")
