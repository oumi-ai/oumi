...
class TestBranchModelState:
    ...
    def test_branch_model_state_restored_on_switch(self, command_handler):
        ...
        branch_result = command_handler._handle_branch(branch_command)
        ...
        with patch(
            ...
            swap_result = command_handler._handle_swap(swap_command)
        ...
        with patch(
            ...
            # Get the branch ID
            branch_id = list(command_handler.branch_manager.branches.keys())[
                1
            ]  # Not main
