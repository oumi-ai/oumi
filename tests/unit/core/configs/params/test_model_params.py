...
class TestFlashAttentionDetection:
    ...
    @patch(
        "oumi.core.configs.params.model_params.flash_attn_interface",
    ...
    def test_resolve_flash_attention_fa3_available(
        self, mock_fa2_available, mock_fa3_available
    ):
    ...
    @patch("oumi.core.configs.params.model_params._is_flash_attn_3_available")
    @patch("oumi.core.configs.params.model_params.is_flash_attn_2_available")
    def test_resolve_flash_attention_fa2_available(
        self, mock_fa2_available, mock_fa3_available
    ):
    ...
    @patch("oumi.core.configs.params.model_params._is_flash_attn_3_available")
    @patch("oumi.core.configs.params.model_params.is_flash_attn_2_available")
    def test_resolve_flash_attention_fallback_to_sdpa(
        self, mock_fa2_available, mock_fa3_available
    ):
    ...
    @patch("oumi.core.configs.params.model_params.logger")
    @patch("oumi.core.configs.params.model_params._is_flash_attn_3_available")
    def test_resolve_flash_attention_deprecation_warning(
        self, mock_fa3_available, mock_logger
    ):
...
class TestModelParamsAttentionResolution:
    ...
    @patch(
        "oumi.core.configs.params.model_params._resolve_flash_attention_implementation"
    )
    def test_finalize_and_validate_resolves_attention(self, mock_resolve, tmp_path):
        ...
        params = ModelParams(
            model_name=str(tmp_path), attn_implementation="flash_attention"
        )
        params.finalize_and_validate()
