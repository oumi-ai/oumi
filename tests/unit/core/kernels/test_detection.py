...
class TestKernelsDetection:
    ...
    @patch("oumi.core.kernels.detection.is_kernels_available")
    def test_is_flash_attn3_kernel_available_success(
        self, mock_kernels_available, mock_get_kernel
    ):
    ...
    @patch("oumi.core.kernels.detection.get_kernel")
    @patch("oumi.core.kernels.detection.is_kernels_available")
    def test_is_flash_attn3_kernel_available_exception(
        self, mock_kernels_available, mock_get_kernel
    ):
    ...
    @patch("oumi.core.kernels.detection.is_kernels_available")
    def test_get_available_kernels_info(
        self, mock_kernels_available, mock_flash_attn3_available
    ):
...
class TestLoadFlashAttn3Kernel:
    ...
    @patch("oumi.core.kernels.detection.get_kernel")
    @patch("oumi.core.kernels.detection.is_kernels_available")
    def test_load_flash_attn3_kernel_success(
        self, mock_kernels_available, mock_get_kernel
    ):
    ...
    @patch("oumi.core.kernels.detection.get_kernel")
    @patch("oumi.core.kernels.detection.is_kernels_available")
    def test_load_flash_attn3_kernel_returns_none(
        self, mock_kernels_available, mock_get_kernel
    ):
    ...
    @patch("oumi.core.kernels.detection.get_kernel")
    @patch("oumi.core.kernels.detection.is_kernels_available")
    def test_load_flash_attn3_kernel_exception(
        self, mock_kernels_available, mock_get_kernel
    ):
        ...
        with pytest.raises(
            RuntimeError, match="Failed to load flash-attn3 kernel: Network error"
        ):
            load_flash_attn3_kernel()
