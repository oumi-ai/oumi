...
class TestCommandRouter:
    ...
    def test_execute_command_with_handler_error(self):
        ...
        parsed_cmd = ParsedCommand(command="save", args=["test.json"], kwargs={}, raw_input="/save(test.json)")
    ...
    def test_command_result_consistency(self):
        ...
        test_commands = [
            ...
            ParsedCommand(command="save", args=["test.json"], kwargs={}, raw_input="/save(test.json)"),
        ]
        ...
        for parsed_cmd in test_commands:
            ...
            assert result.message is None or (isinstance(result.message, str) and len(result.message) > 0)
