...
def test_convert_conversation_to_api_input_with_unsupported_params():
    """Test conversion with unsupported params."""

    def _get_supported_params_override():
        return {
            # Keys generated by `get_supported_params` (selected 3 of many).
            "model",
            "messages",
            "frequency_penalty",
            # Keys not generated by `get_supported_params`.
            "some_key",
            "some_other_key",
        }
    ...
    engine.get_supported_params = _get_supported_params_override
    ...
    result = engine._convert_conversation_to_api_input(conversation, GenerationParams())
    assert result.keys() == {"model", "messages", "frequency_penalty"}
