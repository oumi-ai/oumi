...
# Download Gemma-3-270m for VLLM testing
download_with_retry "google/gemma-3-270m"

# Add delay between downloads to avoid rate limiting  
sleep 10

# Download GGUF quantized model for LlamaCpp testing
download_with_retry "unsloth/gemma-3-270m-it-GGUF" --include "gemma-3-270m-it-Q4_K_M.gguf"
