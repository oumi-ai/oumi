...
class TestFileUploadFunctionality:
    ...
    async def test_file_upload_via_websocket(self):
        ...
        mock_file = create_mock_file_upload("test_document.txt", test_content, "text/plain")
    ...
    async def test_image_upload_and_processing(self):
        ...
        png_data = bytes.fromhex("89504e470d0a1a0a0000000d4948445200000001000000010802000000909c60370000000c49444154789c626001000000050001b3b5b7560000000049454e44ae426082")
    ...
    def test_file_attachment_with_conversation(self):
        ...
        with mock_webchat_server() as server:
            ...
            session.add_message("assistant", "I'd be happy to help! Please share the data file.")
            ...
            session.add_message("assistant", "I can see the CSV file. Let me analyze it...")
