...
from tests.oumi_chat.utils._real_model_utils import (
...
class TestChatFuzzingBasic:
    ...
    def test_rapid_message_sequence(self):
        ...
        with chat_session.real_inference_session():
            ...
            assert (
                len(successful_responses) >= len(responses) * 0.8
        ...
        with chat_session.real_inference_session():
            ...
            for i, edge_case in enumerate(edge_cases):
                try:
                    ...
                    results.append(
                        ("success" if result.success else "graceful_failure", edge_case)
                    )
            ...
            final_test = chat_session.send_message_with_real_inference(
    ...
    def test_branch_explosion(self):
        ...
        with chat_session.real_inference_session():
            ...
            final_result = chat_session.send_message_with_real_inference(
                "Final message after branch attempts"
            )
...
class TestChatFuzzingGPU:
    ...
    def test_extended_conversation_stress(self):
        ...
        with chat_session.real_inference_session():
            ...
            assert successful_exchanges >= 30, (
                f"Only {successful_exchanges} successful exchanges"
            )
    ...
    def test_file_system_stress(self):
        ...
        try:
            with chat_session.real_inference_session():
                ...
                for i in range(20):
                    ...
                    if result.success:
                        ...
                        if i % 5 == 0:
                            ...
                            export_result = chat_session.inject_command(
                                f"/save({export_path})"
                            )
                ...
                assert (
                    len(existing_files) >= save_successes * 0.8
    ...
    def test_marathon_conversation(self):
        ...
        with chat_session.real_inference_session():
            ...
            assert len(milestones_reached) >= 2, (
                f"Only reached milestones: {milestones_reached}"
            )
