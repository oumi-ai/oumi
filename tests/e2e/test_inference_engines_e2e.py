...
# ============================================================================
# OpenAI Usage Tracking E2E Tests
# ============================================================================


@pytest.mark.e2e
def test_openai_basic_text_generation():
    """Test basic text generation with OpenAI (with usage tracking)."""
    ...
    conversation = create_simple_conversation("What is 2 + 2?")
    result = engine.infer([conversation])[0]

    assert_valid_response(result)
    usage = assert_usage_tracked(result)
    print(f"OpenAI basic test passed - {usage['total_tokens']} tokens used")


# ============================================================================
# Anthropic Usage Tracking E2E Tests
# ============================================================================


@pytest.mark.e2e
def test_anthropic_basic_text_generation():
    """Test basic text generation with Anthropic (with usage tracking)."""
    ...
    assert_valid_response(result)
    usage = assert_usage_tracked(result)
    print(f"Anthropic basic test passed - {usage['total_tokens']} tokens used")


# ============================================================================
# Together.ai Usage Tracking E2E Tests
# ============================================================================


@pytest.mark.e2e
def test_together_basic_text_generation():
    """Test basic text generation with Together.ai (with usage tracking)."""
    ...
    assert_valid_response(result)
    usage = assert_usage_tracked(result)
    print(f"Together basic test passed - {usage['total_tokens']} tokens used")
