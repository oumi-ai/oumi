        ...
        def _infer(
            ...
            for conversation in input:
                ...
                chat_response = self._llm.chat(
                    vllm_input, sampling_params=sampling_params
                )
                new_messages = [
        ...
        def infer_online(
            ...
            if generation_config.output_filepath:
                self._save_conversations(
                    conversations, generation_config.output_filepath
                )
...
class VLLMInferenceEngine(BaseInferenceEngine):
    ...
    def infer_online(
        ...
        return self._internal_engine.infer_online(input, generation_config)
    ...
    def infer_from_file(
        ...
        return self._internal_engine.infer_from_file(input_filepath, generation_config)
