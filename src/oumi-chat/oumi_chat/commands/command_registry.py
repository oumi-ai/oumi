...
# Global command registry - simple dictionary of command name -> CommandInfo
COMMANDS = {
    # Basic commands
    "help": CommandInfo(
        name="help",
...
# Backwards compatibility - create a CommandRegistry class that wraps the dict
class CommandRegistry:
    """Legacy wrapper for backward compatibility.

    New code should use the COMMANDS dict and helper functions directly.
    """
