...
class LLMJudgmentMetrics(BaseModel):
    ...
    reasoning: str = Field(description="LLM's explanation for the judgment")
...
class LLMAnalyzer(ConversationAnalyzer[LLMJudgmentMetrics]):
    r"""Generalized LLM-as-judge analyzer with preset and custom prompts.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Support both 'criteria' and 'criteria_name' for preset lookup
        ...
        if preset_key:
            ...
            raise ValueError(
                "Must provide either 'criteria'/'criteria_name' "
                "(preset) or 'prompt_template' (custom)"
            )
...
{format_instruction}"""
    ...
    def from_api_judge_config(
        ...
        **kwargs: Any,
        ...
        r"""Create LLMAnalyzer from API judge configuration.
...
class UsefulnessAnalyzer(LLMAnalyzer):
    ...
    def __init__(self, **kwargs: Any):
        """Initialize with usefulness criteria defaults."""
...
class SafetyAnalyzer(LLMAnalyzer):
    ...
    def __init__(self, **kwargs: Any):
        """Initialize with safety criteria defaults."""
...
class FactualityAnalyzer(LLMAnalyzer):
    ...
    def __init__(self, **kwargs: Any):
        """Initialize with factuality criteria defaults."""
...
class CoherenceAnalyzer(LLMAnalyzer):
    ...
    def __init__(self, **kwargs: Any):
        """Initialize with coherence criteria defaults."""
...
class InstructionFollowingAnalyzer(LLMAnalyzer):
    ...
    def __init__(self, **kwargs: Any):
        """Initialize with instruction_following criteria defaults."""
