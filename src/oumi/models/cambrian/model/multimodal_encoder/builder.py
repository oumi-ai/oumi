    ...
    for vision_tower_aux_name, vision_tower_aux_token_len in zip(
        ...
        if "maws" in vision_tower_aux_name.lower():
            ...
            vision_tower_aux_list.append(
                MawsVisionTower(vision_tower_aux_name, args=config, **kwargs)
            )
        ...
        # CLIP-based Vision Towers
            ...
            logger.info(
                f"Loading **Apple DFN CLIP** Vision Tower: {vision_tower_aux_name}"
            )
            vision_tower_aux_list.append(
                DfnClipVisionTower(vision_tower_aux_name, args=config, **kwargs)
            )
            ...
            vision_tower_aux_list.append(
                EvaClipVisionTower(vision_tower_aux_name, args=config, **kwargs)
            )
        ...
        # Supervised Vision Towers
            ...
            vision_tower_aux_list.append(
                SupervisedViT_VisionTower(vision_tower_aux_name, args=config, **kwargs)
            )
        ...
        # Other Vision Towers
            ...
            vision_tower_aux_list.append(
                HybridVisionTower(vision_tower_aux_name, args=config, **kwargs)
            )
        elif "diffusion" in vision_tower_aux_name.lower():
            logger.info(
                f"Loading **Diffusion CLIP** Vision Tower: {vision_tower_aux_name}"
            )
            vision_tower_aux_list.append(
                DiffusionVisionTower(vision_tower_aux_name, args=config, **kwargs)
            )
        elif "midas" in vision_tower_aux_name.lower():
            logger.info(f"Loading **MiDaS** Vision Tower: {vision_tower_aux_name}")
            vision_tower_aux_list.append(
                MiDaSVisionTower(vision_tower_aux_name, args=config, **kwargs)
            )
        elif "sam" in vision_tower_aux_name.lower():
            logger.info(f"Loading **SAM Vision Tower: {vision_tower_aux_name}")
            vision_tower_aux_list.append(
                SAMVisionTower(vision_tower_aux_name, args=config, **kwargs)
            )
        else:
