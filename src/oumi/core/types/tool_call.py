...
class FunctionCall(BaseModel):
    ...
    def _coerce_arguments(cls, raw: Any) -> str:
        ...
        core validator enforces the ``str`` type. String inputs pass
        through; Pydantic handles the rest.
        """
    ...
    def parsed_arguments(self) -> dict[str, Any]:
        ...
        The string is the storage contract (see the ``arguments`` docstring);
        every consumer that needs structure decodes here rather than
        hand-rolling ``json.loads``.
        """
