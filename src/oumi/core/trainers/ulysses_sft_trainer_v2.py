...
from .arctic_base_trainer import ArcticBaseTrainer, TrainerRegistry, ComponentFactory
from .components.sequence_parallel import (
    SequenceParallelConfig,
    SequenceParallelManager,
    SequenceParallelLossComputer,
)
from .components.memory_optimization import MemoryOptimizer, LigerKernelOptimizer
...
class UlyssesSFTTrainer(ArcticBaseTrainer):
    ...
    def _setup_optimizations(self):
        ...
        if self.use_liger_kernel:
            if LigerKernelOptimizer.is_available():
                LigerKernelOptimizer.apply_liger_kernels(self.model, self.use_liger_kernel)
            else:
    ...
    def get_scheduler(self, name: str, optimizer, num_warmup_steps: int, num_training_steps: int):
