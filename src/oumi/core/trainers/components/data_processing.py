...
class SequencePacker:
    ...
    def pack_samples(self, samples: List[Dict[str, torch.Tensor]]) -> List[Dict[str, torch.Tensor]]:
        ...
        for sample in samples:
            ...
            if needed_length <= self.max_length:
                ...
                if current_input_ids:
                    packed_samples.append(self._finalize_packed_sample(
