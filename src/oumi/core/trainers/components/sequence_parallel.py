...
class SequenceParallelManager:
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            logger.info("Ulysses SP attention patches applied successfully using DeepSpeed")
            return True
    ...
    def wrap_dataloader(self, dataloader: DataLoader, device: Optional[torch.device] = None) -> DataLoader:
        ...
        try:
            ...
            logger.info("Successfully wrapped dataloader with UlyssesSPDataLoaderAdapter")
...
class SequenceParallelLossComputer:
    ...
    def __init__(self, sp_manager: SequenceParallelManager, use_liger_kernel: bool = False):
    ...
    def _compute_loss_with_sp(
        ...
        if self.use_liger_kernel:
            ...
            loss = MemoryOptimizer.compute_tiled_logits_loss(model, inputs, shift_labels)
