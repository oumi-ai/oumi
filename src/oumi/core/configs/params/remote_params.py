...
class RemoteParams(BaseParams):
    ...
    """Initial concurrency for adaptive mode (when num_workers=0).

    When num_workers=0 (fully adaptive mode), this allows you to specify the starting
    concurrency level. If not specified, defaults to min_concurrency (10).
    This is useful for testing or when you have a good estimate of the starting point.
    """
