...
class StyleParams(BaseParams):
    ...
    def __post_init__(self):
        ...
        valid_box_styles = {
            "rounded", "square", "double", "heavy", "minimal", "ascii"
        }
        ...
        valid_code_themes = {
            "monokai", "github-dark", "dracula", "nord",
            "solarized-dark", "solarized-light", "material", "native"
        }
        ...
        if self.markdown_code_theme and self.markdown_code_theme not in valid_code_themes:
            raise ValueError(
        ...
        if len(self.assistant_padding) != 2:
            raise ValueError("assistant_padding must be a tuple of (vertical, horizontal)")
