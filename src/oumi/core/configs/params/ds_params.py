...
class DSParams(BaseParams):
    ...
    def __post_init__(self) -> None:
        ...
        if (self.offload_optimizer is not None and 
            self.zero_stage not in [ZeRORuntimeStage.ZERO_2, ZeRORuntimeStage.ZERO_3]):
            raise ValueError(
    ...
    def to_deepspeed_config(self) -> dict[str, Any]:
        ...
        if self.zero_stage in [ZeRORuntimeStage.ZERO_0, ZeRORuntimeStage.ZERO_1, ZeRORuntimeStage.ZERO_2]:
            zero_config.update({
