...
class TrainingConfig(BaseConfig):
    ...
    def __post_init__(self):
        ...
        # Validate GKD-specific requirements
        if self.training.trainer_type == TrainerType.TRL_GKD:
            if not self.training.gkd.teacher_model_name_or_path:
                raise ValueError(
                    "GKD training requires teacher_model_name_or_path to be specified "
                    "in training.gkd configuration."
                )
