...
class SafetyAnalyzer(SampleAnalyzer):
    ...
    def get_output_schema(
        ...
        aid: str = analyzer_id or getattr(self, "analyzer_id", "safety")
        ...
        for column in text_columns:
            ...
            output_schema[col_name] = {
                ...
                "description": "Safety score (0-1, higher = safer)",
            }
            col_name = make_analyzer_column_name(column, aid, "is_safe")
            output_schema[col_name] = {
                "type": ColumnType.BOOL,
                "content_type": ContentType.BOOLEAN,
                "description": "Whether content is considered safe",
            }
            col_name = make_analyzer_column_name(column, aid, "risk_level")
            output_schema[col_name] = {
            ...
            if self.include_categories:
                col_name = make_analyzer_column_name(column, aid, "categories_triggered")
                output_schema[col_name] = {
                    "type": ColumnType.STRING,
                    "content_type": ContentType.LIST,
                    "description": "Comma-separated list of triggered safety categories",
                }
