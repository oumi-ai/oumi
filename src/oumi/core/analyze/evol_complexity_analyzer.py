...
JSON ranking:"""
    ...
    def get_output_schema(
        ...
        aid: str = analyzer_id or getattr(self, "analyzer_id", "evol_complexity")
        ...
        for column in text_columns:
            ...
            output_schema[col_name] = {
                ...
                "description": "Complexity score (ELO-based)",
            }
            col_name = make_analyzer_column_name(column, aid, "rank")
            output_schema[col_name] = {
                "type": ColumnType.INT,
                "content_type": ContentType.NUMERIC,
                "description": "Complexity rank",
            }
            col_name = make_analyzer_column_name(column, aid, "headroom")
            output_schema[col_name] = {
                "type": ColumnType.FLOAT,
                "content_type": ContentType.NUMERIC,
                "description": "Potential for complexity improvement",
            }
