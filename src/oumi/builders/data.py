...
def _load_dataset(
    ...
    if not stream or True:
        ...
        # if `stream=True` then the dataset is not fully post-processed before training
        # starts: it's returned as `IterableDataset` with lazy feature generation.
