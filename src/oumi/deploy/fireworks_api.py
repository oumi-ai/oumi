...
``oumi-stack-admin/scripts/fireworks/fireworks.openapi.yaml`` (version 4.27.5).
...
class GatewayBaseModelDetails(_FWBaseModel):
    ...
    huggingface_files: list[str] | None = Field(
        default=None, alias="huggingfaceFiles"
    )
...
class GatewayAutoscalingPolicy(_FWBaseModel):
    ...
    scale_to_zero_window: str | None = Field(
        default=None, alias="scaleToZeroWindow"
    )
    load_targets: dict[str, float] | None = Field(
        default=None, alias="loadTargets"
    )
...
class GatewayReplicaStats(_FWBaseModel):
    ...
    ready_replica_count: int | None = Field(
        default=None, alias="readyReplicaCount"
    )
...
class GatewayModel(_FWBaseModel):
    ...
    peft_details: GatewayPEFTDetails | None = Field(
        default=None, alias="peftDetails"
    )
    public: bool | None = None
    ...
    supports_image_input: bool | None = Field(
        default=None, alias="supportsImageInput"
    )
    ...
    default_draft_model: str | None = Field(
        default=None, alias="defaultDraftModel"
    )
    ...
    supported_precisions_with_calibration: list[DeploymentPrecision] | None = (
        Field(default=None, alias="supportedPrecisionsWithCalibration")
    )
    training_context_length: int | None = Field(
        default=None, alias="trainingContextLength"
    )
    supports_serverless: bool | None = Field(
        default=None, alias="supportsServerless"
    )
...
class GatewayDeployment(_FWBaseModel):
    ...
    desired_replica_count: int | None = Field(
        default=None, alias="desiredReplicaCount"
    )
    ...
    base_model: str = Field(alias="baseModel")
    accelerator_count: int | None = Field(
    ...
    draft_token_count: int | None = Field(
        default=None, alias="draftTokenCount"
    )
    ...
    deployment_template: str | None = Field(
        default=None, alias="deploymentTemplate"
    )
    max_context_length: int | None = Field(
        default=None, alias="maxContextLength"
    )
    update_time: datetime | None = Field(default=None, alias="updateTime")
    ...
    active_model_version: str | None = Field(
        default=None, alias="activeModelVersion"
    )
    target_model_version: str | None = Field(
        default=None, alias="targetModelVersion"
    )
...
class GatewayScaleDeploymentBody(_FWBaseModel):
    """GatewayScaleDeploymentBody — request to scale a deployment."""

    replica_count: int | None = Field(default=None, alias="replicaCount")


class GatewayDeployedModel(_FWBaseModel):
    """gatewayDeployedModel — LoRA deployed-model resource schema."""
...
class GatewayGetModelDownloadEndpointResponse(_FWBaseModel):
    """Response from getDownloadEndpoint — maps filenames to signed URLs."""
...
class GatewayValidateModelUploadResponse(_FWBaseModel):
    """Response from validateUpload."""
...
class GatewayListDeployedModelsResponse(_FWBaseModel):
    """gatewayListDeployedModelsResponse — paginated list of deployed models."""

    deployed_models: list[GatewayDeployedModel] | None = Field(
        default=None, alias="deployedModels"
    )
    next_page_token: str | None = Field(default=None, alias="nextPageToken")
    total_size: int | None = Field(default=None, alias="totalSize")
