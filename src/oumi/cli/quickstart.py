...
def select_from_choices(
    ...
    Args:
        ...
        choices: List of choice dictionaries with name, description (optional), and
                value, or dictionary of choice descriptions to values, or list of
                choices.
...
def quickstart():
    ...
    console.print(
        "- Training Guide: [blue underline]https://oumi.ai/docs/en/latest/user_guides/train/train.html[/blue underline]"  # noqa E501
    )
    console.print(
        "- Configuration Reference: [blue underline]https://oumi.ai/docs/en/latest/user_guides/train/configuration.html[/blue underline]"  # noqa E501
    )
    console.print(
        "- Example Configs: [blue underline]https://github.com/oumi-ai/oumi/tree/main/configs/recipes[/blue underline]"  # noqa E501
    )
    ...
    console.print(
        "- Evaluation Guide: [blue underline]https://oumi.ai/docs/en/latest/user_guides/evaluate/evaluate.html[/blue underline]"  # noqa E501
    )
    console.print(
        "- Available Tasks: [blue underline]https://oumi.ai/docs/en/latest/user_guides/evaluate/evaluate.html#available-tasks[/blue underline]"  # noqa E501
    )
    console.print(
    ...
    try:
        ...
        if results_dir.exists():
            ...
            for run_folder in run_folders:
                result_file = run_folder / "task_result.json"
