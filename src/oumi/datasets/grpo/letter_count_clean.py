...
class LetterCountCleanGrpoDataset(BaseExperimentalGrpoDataset):
    """Dataset class for the `oumi-ai/oumi-letter-count-clean` dataset.
    ...
    default_dataset = "oumi-ai/oumi-letter-count-clean"
