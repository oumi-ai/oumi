...
Scanned **495** configs in 3858.6s.
...
- examples/fineweb_ablation_pretraining/ddp/train.yaml: passed in 27.2s (16.0 GB)
- examples/fineweb_ablation_pretraining/fsdp/train.yaml: passed in 23.4s (16.0 GB)
- examples/gkd/train.yaml: passed in 2.6s (1.3 GB)
- examples/gold/train.yaml: passed in 2.4s (1.3 GB)
- examples/gold/train_gptoss120b_qwen06b.yaml: passed in 8.4s (5.6 GB)
- examples/gold/train_gptoss120b_qwen8b.yaml: **FAILED** — Skipped: model needs ~84.6 GB GPU but only 43.7 GB free (7.6B params)
- examples/grpo_tldr/train.yaml: passed in 7.4s (4.7 GB)
- examples/grpo_verl_countdown/train.yaml: passed in 43.7s (30.0 GB)
- examples/grpo_verl_geometry3k/train.yaml: passed in 125.3s (35.6 GB)
- examples/grpo_verl_gsm8k/train.yaml: passed in 7.9s (4.7 GB)
- examples/letter_counting/grpo/train.yaml: passed in 46.5s (30.0 GB)
- examples/misc/tulu3_sft_mini.yaml: passed in 1.4s (0.2 GB)
...
- projects/coalm/8b_train.yaml: passed in 104.9s (16.8 GB)
...
- recipes/deepseek_r1/sft/distill_llama_8b/lora_train.yaml: passed in 93.0s (15.9 GB)
- recipes/deepseek_r1/sft/distill_llama_8b/qlora_train.yaml: passed in 102.4s (16.6 GB)
- recipes/deepseek_r1/sft/distill_qwen_1_5b/full_train.yaml: passed in 26.5s (16.6 GB)
- recipes/deepseek_r1/sft/distill_qwen_1_5b/lora_train.yaml: passed in 29.8s (4.9 GB)
...
- recipes/falcon_e/dpo/falcon_e_1b_instruct/dpo.yaml: passed in 22.1s (16.0 GB)
- recipes/falcon_e/sft/falcon_e_1b/full_train.yaml: passed in 22.1s (16.0 GB)
- recipes/falcon_e/sft/falcon_e_1b_instruct/full_train.yaml: passed in 22.8s (16.0 GB)
- recipes/falcon_e/sft/falcon_e_3b/full_train.yaml: passed in 43.2s (28.5 GB)
- recipes/falcon_e/sft/falcon_e_3b_instruct/full_train.yaml: passed in 44.5s (28.5 GB)
...
- recipes/gemma2/sft/2b_full/train.yaml: passed in 36.0s (24.4 GB)
- recipes/gemma3/sft/12b_lora/train.yaml: passed in 361.0s (31.3 GB)
...
- recipes/gpt2/pretraining/macos_train.yaml: passed in 2.8s (1.2 GB)
- recipes/gpt2/pretraining/train.yaml: passed in 2.8s (1.2 GB)
...
- recipes/llama3_1/sft/8b_lora/fsdp_train.yaml: passed in 90.0s (15.9 GB)
- recipes/llama3_1/sft/8b_lora/train.yaml: passed in 93.0s (15.9 GB)
- recipes/llama3_1/sft/8b_qlora/train.yaml: passed in 90.3s (16.6 GB)
- recipes/llama3_2/dpo/1b_qlora_dpo.yaml: passed in 17.3s (3.0 GB)
- recipes/llama3_2/sft/1b_full/train.yaml: passed in 16.5s (11.6 GB)
- recipes/llama3_2/sft/3b_full/fsdp_train.yaml: passed in 42.7s (30.0 GB)
- recipes/llama3_2/sft/3b_full/train.yaml: passed in 43.4s (30.0 GB)
- recipes/llama3_2/sft/3b_lora/fsdp_train.yaml: passed in 47.0s (7.9 GB)
- recipes/llama3_2/sft/3b_lora/train.yaml: passed in 45.7s (7.9 GB)
- recipes/llama3_2/sft/3b_qlora/fsdp_train.yaml: passed in 47.9s (7.9 GB)
- recipes/llama3_2/sft/3b_qlora/train.yaml: passed in 48.5s (7.9 GB)
...
- recipes/phi3/dpo/macos_train.yaml: passed in 46.2s (8.0 GB)
- recipes/phi3/dpo/nvidia_24g_train.yaml: passed in 45.5s (7.7 GB)
- recipes/phi3/dpo/nvidia_80g_train.yaml: passed in 46.3s (8.0 GB)
- recipes/phi3/dpo/train.yaml: passed in 44.3s (8.0 GB)
- recipes/phi3/kto/train.yaml: passed in 44.3s (8.0 GB)
- recipes/phi3/sft/lora_macos_train.yaml: passed in 42.1s (8.0 GB)
- recipes/phi3/sft/lora_train.yaml: passed in 43.2s (8.0 GB)
...
- recipes/qwen2_5/sft/3b_full/train.yaml: passed in 37.7s (29.3 GB)
- recipes/qwen2_5/sft/7b_full/train.yaml: **FAILED** — Skipped: model needs ~79.0 GB GPU but only 43.8 GB free (7.1B params)
- recipes/qwen3/sft/0.6b_full/train.yaml: passed in 8.2s (5.6 GB)
- recipes/qwen3/sft/1.7b_full/train.yaml: passed in 21.0s (16.1 GB)
...
- recipes/qwen3_5/sft/0.8b_full/train.yaml: passed in 39.3s (8.2 GB)
- recipes/qwen3_5/sft/0.8b_lora/train.yaml: passed in 38.9s (2.4 GB)
...
- recipes/smollm/sft/135m/quickstart_train.yaml: passed in 2.7s (1.3 GB)
- recipes/smollm/sft/135m/train.yaml: passed in 2.9s (1.3 GB)
- recipes/vision/internvl3/sft/full/train.yaml: passed in 29.9s (7.6 GB)
...
- recipes/vision/llama3_2_vision/sft/11b_lora/train.yaml: passed in 277.7s (36.3 GB)
...
- recipes/vision/qwen2_5_vl_3b/dpo/train.yaml: passed in 104.7s (35.6 GB)
- recipes/vision/qwen2_5_vl_3b/sft/full/train.yaml: passed in 100.2s (35.6 GB)
- recipes/vision/qwen2_5_vl_3b/sft/lora/train.yaml: passed in 108.8s (8.7 GB)
...
- recipes/vision/qwen2_vl_2b/dpo/train.yaml: passed in 62.4s (20.6 GB)
- recipes/vision/qwen2_vl_2b/sft/full/train.yaml: passed in 60.1s (20.6 GB)
- recipes/vision/qwen2_vl_2b/sft/lora/train.yaml: passed in 63.2s (4.8 GB)
- recipes/vision/qwen3_vl_2b/sft/2b_instruct_fft_train.yaml: passed in 63.9s (19.9 GB)
- recipes/vision/qwen3_vl_2b/sft/2b_instruct_lora_train.yaml: passed in 64.9s (4.5 GB)
...
- recipes/vision/qwen3_vl_4b/sft/4b_instruct_lora_train.yaml: passed in 125.4s (9.3 GB)
- recipes/vision/smolvlm/sft/full/train.yaml: passed in 59.0s (29.2 GB)
- recipes/vision/smolvlm/sft/lora/train.yaml: passed in 58.5s (24.4 GB)
