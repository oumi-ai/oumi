...
def build_classifier_instruction(
    ...
    return f"""You are a banking intent classifier. Classify the user's query \
into one of 77 banking intents (output is a single integer ID).
...
def main() -> None:
    ...
    #             row,
    #             labels,
    #             in_context_examples=random.sample(in_context_examples, 1),
    #         )
    #         for row in df_test.to_dict("records")
    #     ],
    ...
    #             row,
    #             labels,
    #             in_context_examples=random.sample(in_context_examples, 3),
    #         )
    #         for row in df_test.to_dict("records")
    #     ],
    ...
    #             row,
    #             labels,
    #             in_context_examples=random.sample(in_context_examples, 5),
    #         )
    #         for row in df_test.to_dict("records")
    #     ],
