...
CUDA_VISIBLE_DEVICES=0 python run.py --input_file data/bitext_test.json --output_file output/qwen2.5_7b_bitext_baseline.json --inference_config infer_configs/qwen2.5_7b.yaml &
CUDA_VISIBLE_DEVICES=1 python run.py --input_file data/bitext_test.json --output_file output/qwen3_8b_bitext_baseline.json --inference_config infer_configs/qwen3_8b.yaml &
wait
