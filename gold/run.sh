...
CUDA_VISIBLE_DEVICES=0 python run.py --input_file tatqa_data/test_modified.jsonl --output_file output/tatqa_llama_lambda0.5_1epoch_lora_bf16_new_version.jsonl --inference_config infer_configs/tatqa_llama_lambda0.5_1epoch_lora_bf16_new_version.yaml | 2>&1 tee infer_logs/tatqa_llama_lambda0.5_1epoch_lora_bf16_new_version.log &
wait
