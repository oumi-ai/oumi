...
NQ (Natural Questions) | Open domain question answering benchmark that is derived from Natural Questions. The goal is to predict an English answer string for an input English question [[details](https://research.google/pubs/natural-questions-a-benchmark-for-question-answering-research/)] | Closed-Book (free-form answer) | `nq_open` | 2019, by Google in TACL
SQuAD V2 (Stanford Question Answering Dataset) | Reading comprehension dataset, consisting of questions posed by crowdworkers on a set of Wikipedia articles. The answer is a segment of text rom the reading passage or unanswerable [[details](https://arxiv.org/abs/1806.03822)] | Open-Book (free-form answer) | `squadv2` | 2018, by Stanford in ACL
...
ARC Challenge (AI2 Reasoning Challenge) | Challenging multiple-choice science questions from the ARC dataset. Answered incorrectly by the authors a retrieval-based and word co-occurrence algorithms [[details](https://arxiv.org/abs/1803.05457)] | Closed-Book (multichoice answer) | `arc_challenge` | 2018, by Allen Institute for AI
...
|------|-------------|-----------|------------|
Commonsense QA | Multiple-choice question answering dataset that requires different types of commonsense knowledge to predict the correct answer among one correct answer and four distractor answers [[details](https://arxiv.org/pdf/1811.00937.pdf)] | `commonsense_qa` | 2019, by Tel-Aviv University and Allen Institute for AI
PIQA (Physical Interaction QA) | Physical commonsense reasoning to investigate the physical knowledge of existing models, including basic properties of the real-world objects  [[details](https://arxiv.org/abs/1911.11641)] | `piqa` | 2019, by Allen Institute for AI, MSR, CMU, UW
SocialIQA (Social Interaction QA) | Commonsense reasoning about social situations, probing emotional and social intelligence in a variety of everyday situations [[details](https://arxiv.org/abs/1904.09728)] | `siqa` | 2019, by Allen Institute for AI, UW
SWAG (Situations With Adversarial Generations) | Grounded commonsense reasoning. Question is a video caption with answer choices about what might happen next in the scene: 1 correct and 3 adversarially generated choices [[details](https://arxiv.org/abs/1808.05326)] | `swag` | 2019, by UW, Allen Institute for AI
HellaSWAG | Benchmark that builds on the SWAG to evaluate understanding and common sense reasoning, particularly in the context of completing sentences or narratives [[details](https://arxiv.org/abs/1905.07830)] | `hellaswag` | 2019, by UW, Allen Institute for AI
WinoGrande | Given sentence which requires commonsense reasoning, choose the right option among multiple choices. Inspired by Winograd Schema Challenge (WSC) [[details](https://arxiv.org/abs/1907.10641)] | `winogrande` | 2019, by Allen Institute for AI
MuSR (Multistep Soft Reasoning) | Multistep soft reasoning tasks specified in a natural language narrative. Requires solving murder mysteries, placing objects, and team allocation [[details](https://arxiv.org/abs/2310.16049)] | `leaderboard_musr` | 2024, by UT Austin in ICLR
DROP (Discrete Reasoning Over Paragraphs) | Reading comprehension benchmark, requiring resolving references in a question to multiple input positions and performing discrete operations over them (such as addition, counting, or sorting) [[details](https://arxiv.org/abs/1903.00161)] | `drop` | 2019, by UC Irvine, Peking University and others
...
BBH (Big Bench Hard) | Challenging tasks from the BIG-Bench evaluation suite, focusing on complex reasoning, multi-step problem solving, and requiring deep understanding rather than surface-level pattern matching [[details](https://arxiv.org/abs/2210.09261)] | `bbh` | 2022, by Google Research and Stanford
...
| Task | Description | Task Name | Introduced |
|------|-------------|-----------|------------|
WiC (Words in Context) | Word sense disambiguation task: Identify if the occurrences of a word in two contexts correspond to the same meaning or not. Framed as a binary classification task [[details](https://arxiv.org/abs/1905.00537)] | `wic` | 2019, as part of Superglue
RTE (Recognizing Textual Entailment) | Given two text fragments, recognize whether the meaning of one fragment is can be inferred from the other [[details](https://arxiv.org/abs/1905.00537)] | `rte` | 2019, as part of Superglue
...
IFEval (Instruction Following Evaluation) | Instruction-Following evaluation dataset. Specifically focuses on formatting text, including imposing length constraints, paragraph composition, punctuation, casing (lower/upper), including/exluding keywords, etc [[details](https://arxiv.org/abs/2311.07911)] | `ifeval` | 2023 by Google, Yale University
...
| Task | Description | Task Name | Introduced |
|------|-------------|-----------|------------|
MATH (Mathematics Aptitude Test of Heuristics), Level 5  | Challenging competition mathematics problems with full step-by-step solutions [[details](https://arxiv.org/abs/2103.03874)] | `leaderboard_math_hard` | 2021 by UC Berkeley
