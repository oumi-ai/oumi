...
**Example**: See {gh}`configs/examples/synthesis/conversation_synth.yaml` for a customer support conversation generation example using chained generated attributes.
