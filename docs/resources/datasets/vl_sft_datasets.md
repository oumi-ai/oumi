...
## HuggingFaceM4/the_cauldron Dataset
...
To use the `HuggingFaceM4/the_cauldron` dataset in your Oumi configuration, specify it in the {py:class}`~oumi.core.configs.TrainingConfig`.
...
Using the `HuggingFaceM4/the_cauldron` dataset in code is similar to using other VL-SFT datasets:
