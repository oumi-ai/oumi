...
Scanned **495** configs in 3720.4s.
...
- **configs/recipes/vision/phi3/sft/full/completions_only_train.yaml**: Could not parse with any oumi config class
- **configs/recipes/vision/phi3/sft/full/train.yaml**: Could not parse with any oumi config class
...
- **configs/examples/grpo_verl_geometry3k/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 4
...
- **configs/recipes/gemma3/sft/12b_lora/train.yaml**: Dry-run failed: ValueError: Prompt contained 0 image tokens but received 1 images.
  - model: google/gemma-3-12b-it
estimated: 11.6B params, 21.7 GB weights, 43.3 GB CPU RAM needed
vlm: True
params: 12.2B
LoRA trainable: 18.1M
device: cuda
...
- **configs/recipes/qwen3/sft/8b_full/train.yaml**: Dry-run failed: Skipped: model needs ~84.6 GB GPU but only 43.9 GB free (7.6B params)
  - model: Qwen/Qwen3-8B
estimated: 7.6B params, 14.1 GB weights, 28.2 GB CPU RAM needed
- **configs/recipes/qwen3_5/sft/0.8b_full/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 64
  - model: Qwen/Qwen3.5-0.8B
estimated: 0.6B params, 1.1 GB weights, 2.2 GB CPU RAM needed
vlm: True
params: 0.9B
device: cuda
- **configs/recipes/qwen3_5/sft/0.8b_lora/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 64
  - model: Qwen/Qwen3.5-0.8B
estimated: 0.6B params, 1.1 GB weights, 2.2 GB CPU RAM needed
vlm: True
params: 0.9B
...
- **configs/recipes/qwq/sft/qlora_train.yaml**: Dry-run failed: Skipped: model needs ~119 GB CPU RAM but only 58 GB available (32.0B params)
  - model: Qwen/QwQ-32B
estimated: 32.0B params, 59.6 GB weights, 119.2 GB CPU RAM needed
- **configs/recipes/vision/internvl3/sft/full/train.yaml**: Dry-run failed: ValueError: Number of image placeholders in the prompt does not match the number of images.
  - model: OpenGVLab/InternVL3-1B-hf
estimated: 0.5B params, 0.9 GB weights, 1.8 GB CPU RAM needed
vlm: True
params: 0.8B
device: cuda
- **configs/recipes/vision/llama3_2_vision/sft/11b_full/train.yaml**: Dry-run failed: Skipped: model needs ~103.4 GB GPU but only 43.9 GB free (9.2B params)
  - model: meta-llama/Llama-3.2-11B-Vision-Instruct
estimated: 9.2B params, 17.2 GB weights, 34.5 GB CPU RAM needed
- **configs/recipes/vision/llama3_2_vision/sft/11b_lora/train.yaml**: Dry-run failed: RuntimeError: The expanded size of the tensor (6404) must match the existing size (0) at non-singleton dimension 3.  Target sizes: [1, 32, 3, 6404].  Tensor sizes: [1, 1, 3, 0]
  - model: meta-llama/Llama-3.2-11B-Vision-Instruct
estimated: 9.2B params, 17.2 GB weights, 34.5 GB CPU RAM needed
vlm: True
params: 10.7B
LoRA trainable: 29.5M
device: cuda
...
- **configs/recipes/vision/molmo/sft/molmo_o_full/train.yaml**: Dry-run failed: Skipped: model needs ~84 GB CPU RAM but only 58 GB available (11.2B params)
  - model: oumi-ai/Molmo-7B-O-0924
estimated: 11.2B params, 41.8 GB weights, 83.6 GB CPU RAM needed
- **configs/recipes/vision/phi3/dpo/train.yaml**: Dry-run failed: ImportError: cannot import name 'is_flash_attn_greater_or_equal_2_10' from 'transformers.utils' (/root/miniconda3/envs/oumi/lib/python3.11/site-packages/transformers/utils/__init__.py)
  - model: microsoft/Phi-3-vision-128k-instruct
estimated: 3.7B params, 6.9 GB weights, 13.9 GB CPU RAM needed
- **configs/recipes/vision/phi3/sft/full/completions_only_train.yaml**: Dry-run failed: ValidationError: field 'model.freeze_layers' is not Optional
    full_key: model.freeze_layers
    reference_type=ModelParams
    object_type=ModelParams
- **configs/recipes/vision/phi3/sft/full/train.yaml**: Dry-run failed: ValidationError: field 'model.freeze_layers' is not Optional
    full_key: model.freeze_layers
    reference_type=ModelParams
    object_type=ModelParams
- **configs/recipes/vision/phi3/sft/lora/train.yaml**: Dry-run failed: ImportError: cannot import name 'is_flash_attn_greater_or_equal_2_10' from 'transformers.utils' (/root/miniconda3/envs/oumi/lib/python3.11/site-packages/transformers/utils/__init__.py)
  - model: microsoft/Phi-3-vision-128k-instruct
estimated: 3.7B params, 6.9 GB weights, 13.9 GB CPU RAM needed
...
- **configs/recipes/vision/phi4/sft/lora/train.yaml**: Dry-run failed: ImportError: cannot import name 'SlidingWindowCache' from 'transformers.cache_utils' (/root/miniconda3/envs/oumi/lib/python3.11/site-packages/transformers/cache_utils.py)
  - model: microsoft/Phi-4-multimodal-instruct
estimated: 3.8B params, 7.1 GB weights, 14.3 GB CPU RAM needed
- **configs/recipes/vision/qwen2_5_vl_3b/dpo/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 4
  - model: Qwen/Qwen2.5-VL-3B-Instruct
estimated: 3.1B params, 5.7 GB weights, 11.5 GB CPU RAM needed
vlm: True
params: 3.8B
device: cuda
- **configs/recipes/vision/qwen2_5_vl_3b/sft/full/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 4
  - model: Qwen/Qwen2.5-VL-3B-Instruct
estimated: 3.1B params, 5.7 GB weights, 11.5 GB CPU RAM needed
vlm: True
params: 3.8B
device: cuda
- **configs/recipes/vision/qwen2_5_vl_3b/sft/lora/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 4
  - model: Qwen/Qwen2.5-VL-3B-Instruct
estimated: 3.1B params, 5.7 GB weights, 11.5 GB CPU RAM needed
vlm: True
params: 3.8B
LoRA trainable: 18.6M
device: cuda
- **configs/recipes/vision/qwen2_5_vl_7b/sft/full/train.yaml**: Dry-run failed: Skipped: model needs ~79.0 GB GPU but only 42.5 GB free (7.1B params)
  - model: Qwen/Qwen2.5-VL-7B-Instruct
estimated: 7.1B params, 13.2 GB weights, 26.3 GB CPU RAM needed
- **configs/recipes/vision/qwen2_vl_2b/dpo/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 4
  - model: Qwen/Qwen2-VL-2B-Instruct
estimated: 1.5B params, 2.9 GB weights, 5.8 GB CPU RAM needed
vlm: True
params: 2.2B
device: cuda
- **configs/recipes/vision/qwen2_vl_2b/sft/full/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 4
  - model: Qwen/Qwen2-VL-2B-Instruct
estimated: 1.5B params, 2.9 GB weights, 5.8 GB CPU RAM needed
vlm: True
params: 2.2B
device: cuda
- **configs/recipes/vision/qwen2_vl_2b/sft/lora/train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 4
  - model: Qwen/Qwen2-VL-2B-Instruct
estimated: 1.5B params, 2.9 GB weights, 5.8 GB CPU RAM needed
vlm: True
params: 2.2B
LoRA trainable: 9.2M
device: cuda
- **configs/recipes/vision/qwen3_vl_2b/sft/2b_instruct_fft_train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 64
  - model: Qwen/Qwen3-VL-2B-Instruct
estimated: 1.7B params, 3.2 GB weights, 6.4 GB CPU RAM needed
vlm: True
params: 2.1B
device: cuda
- **configs/recipes/vision/qwen3_vl_2b/sft/2b_instruct_lora_train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 64
  - model: Qwen/Qwen3-VL-2B-Instruct
estimated: 1.7B params, 3.2 GB weights, 6.4 GB CPU RAM needed
vlm: True
params: 2.1B
...
estimated: 3.7B params, 6.8 GB weights, 13.7 GB CPU RAM needed
- **configs/recipes/vision/qwen3_vl_4b/sft/4b_instruct_lora_train.yaml**: Dry-run failed: ValueError: Image features and image tokens do not match, tokens: 0, features: 64
  - model: Qwen/Qwen3-VL-4B-Instruct
estimated: 3.7B params, 6.8 GB weights, 13.7 GB CPU RAM needed
vlm: True
params: 4.4B
LoRA trainable: 16.5M
device: cuda
- **configs/recipes/vision/smolvlm/sft/full/train.yaml**: Dry-run failed: ValueError: The number of images in the text [0] and images [1] should be the same.
  - model: HuggingFaceTB/SmolVLM-Instruct
estimated: 1.7B params, 3.2 GB weights, 6.4 GB CPU RAM needed
vlm: True
params: 2.2B
device: cuda
- **configs/recipes/vision/smolvlm/sft/lora/train.yaml**: Dry-run failed: ValueError: The number of images in the text [0] and images [1] should be the same.
  - model: HuggingFaceTB/SmolVLM-Instruct
estimated: 1.7B params, 3.2 GB weights, 6.4 GB CPU RAM needed
vlm: True
params: 2.2B
LoRA trainable: 10.5M
device: cuda
...
- **configs/recipes/vision/phi3/dpo/train.yaml**: Could not load architecture: Could not instantiate model on meta device
...
- **configs/recipes/vision/phi3/sft/lora/train.yaml**: Could not load architecture: Could not instantiate model on meta device
...
## Dry-Run Results (46 passed, 104 failed)
...
- examples/fineweb_ablation_pretraining/ddp/train.yaml: passed in 25.8s (16.0 GB)
- examples/fineweb_ablation_pretraining/fsdp/train.yaml: passed in 22.2s (16.0 GB)
- examples/gkd/train.yaml: passed in 3.1s (1.3 GB)
- examples/gold/train.yaml: passed in 2.8s (1.3 GB)
- examples/gold/train_gptoss120b_qwen06b.yaml: passed in 8.5s (5.6 GB)
- examples/gold/train_gptoss120b_qwen8b.yaml: **FAILED** — Skipped: model needs ~84.6 GB GPU but only 43.7 GB free (7.6B params)
- examples/grpo_tldr/train.yaml: passed in 6.4s (4.7 GB)
- examples/grpo_verl_countdown/train.yaml: passed in 41.9s (30.0 GB)
- examples/grpo_verl_geometry3k/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 4
- examples/grpo_verl_gsm8k/train.yaml: passed in 7.1s (4.7 GB)
- examples/letter_counting/grpo/train.yaml: passed in 40.7s (30.0 GB)
- examples/misc/tulu3_sft_mini.yaml: passed in 1.5s (0.2 GB)
...
- projects/coalm/8b_train.yaml: passed in 90.2s (16.8 GB)
...
- recipes/deepseek_r1/sft/distill_llama_8b/qlora_train.yaml: passed in 88.8s (16.6 GB)
- recipes/deepseek_r1/sft/distill_qwen_1_5b/full_train.yaml: passed in 22.6s (16.6 GB)
- recipes/deepseek_r1/sft/distill_qwen_1_5b/lora_train.yaml: passed in 24.1s (4.9 GB)
...
- recipes/falcon_e/dpo/falcon_e_1b_instruct/dpo.yaml: passed in 18.8s (16.0 GB)
- recipes/falcon_e/sft/falcon_e_1b/full_train.yaml: passed in 18.6s (16.0 GB)
- recipes/falcon_e/sft/falcon_e_1b_instruct/full_train.yaml: passed in 19.5s (16.0 GB)
- recipes/falcon_e/sft/falcon_e_3b/full_train.yaml: passed in 32.3s (28.5 GB)
- recipes/falcon_e/sft/falcon_e_3b_instruct/full_train.yaml: passed in 48.6s (28.5 GB)
...
- recipes/gemma2/sft/2b_full/train.yaml: passed in 32.5s (24.4 GB)
- recipes/gemma3/sft/12b_lora/train.yaml: **FAILED** — ValueError: Prompt contained 0 image tokens but received 1 images.
...
- recipes/gpt2/pretraining/macos_train.yaml: passed in 2.7s (1.2 GB)
...
- recipes/llama3_1/sft/8b_lora/fsdp_train.yaml: passed in 88.4s (15.9 GB)
- recipes/llama3_1/sft/8b_lora/train.yaml: passed in 87.0s (15.9 GB)
- recipes/llama3_1/sft/8b_qlora/train.yaml: passed in 87.2s (16.6 GB)
- recipes/llama3_2/dpo/1b_qlora_dpo.yaml: passed in 16.9s (3.0 GB)
- recipes/llama3_2/sft/1b_full/train.yaml: passed in 16.7s (11.6 GB)
- recipes/llama3_2/sft/3b_full/fsdp_train.yaml: passed in 39.8s (30.0 GB)
- recipes/llama3_2/sft/3b_full/train.yaml: passed in 38.5s (30.0 GB)
- recipes/llama3_2/sft/3b_lora/fsdp_train.yaml: passed in 44.8s (7.9 GB)
- recipes/llama3_2/sft/3b_lora/train.yaml: passed in 46.4s (7.9 GB)
- recipes/llama3_2/sft/3b_qlora/fsdp_train.yaml: passed in 44.1s (7.9 GB)
- recipes/llama3_2/sft/3b_qlora/train.yaml: passed in 43.3s (7.9 GB)
...
- recipes/phi3/dpo/macos_train.yaml: passed in 41.7s (8.0 GB)
- recipes/phi3/dpo/nvidia_24g_train.yaml: passed in 40.4s (7.7 GB)
- recipes/phi3/dpo/nvidia_80g_train.yaml: passed in 40.2s (8.0 GB)
- recipes/phi3/dpo/train.yaml: passed in 41.4s (8.0 GB)
- recipes/phi3/kto/train.yaml: passed in 41.1s (8.0 GB)
- recipes/phi3/sft/lora_macos_train.yaml: passed in 41.5s (8.0 GB)
- recipes/phi3/sft/lora_train.yaml: passed in 40.2s (8.0 GB)
...
- recipes/qwen2_5/sft/3b_full/train.yaml: passed in 34.9s (29.3 GB)
- recipes/qwen2_5/sft/7b_full/train.yaml: **FAILED** — Skipped: model needs ~79.0 GB GPU but only 43.8 GB free (7.1B params)
- recipes/qwen3/sft/0.6b_full/train.yaml: passed in 7.6s (5.6 GB)
- recipes/qwen3/sft/1.7b_full/train.yaml: passed in 19.7s (16.1 GB)
...
- recipes/qwen3_5/sft/0.8b_full/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 64
- recipes/qwen3_5/sft/0.8b_lora/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 64
...
- recipes/vision/internvl3/sft/full/train.yaml: **FAILED** — ValueError: Number of image placeholders in the prompt does not match the number of images.
- recipes/vision/llama3_2_vision/sft/11b_full/train.yaml: **FAILED** — Skipped: model needs ~103.4 GB GPU but only 43.9 GB free (9.2B params)
- recipes/vision/llama3_2_vision/sft/11b_lora/train.yaml: **FAILED** — RuntimeError: The expanded size of the tensor (6404) must match the existing size (0) at non-singleton dimension 3.  Target sizes: [1, 32, 3, 6404].  Tensor sizes: [1, 1, 3, 0]
...
- recipes/vision/phi3/sft/full/completions_only_train.yaml: **FAILED** — ValidationError: field 'model.freeze_layers' is not Optional
    full_key: model.freeze_layers
    reference_type=ModelParams
    object_type=ModelParams
- recipes/vision/phi3/sft/full/train.yaml: **FAILED** — ValidationError: field 'model.freeze_layers' is not Optional
    full_key: model.freeze_layers
    reference_type=ModelParams
    object_type=ModelParams
...
- recipes/vision/qwen2_5_vl_3b/dpo/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 4
- recipes/vision/qwen2_5_vl_3b/sft/full/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 4
- recipes/vision/qwen2_5_vl_3b/sft/lora/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 4
- recipes/vision/qwen2_5_vl_7b/sft/full/train.yaml: **FAILED** — Skipped: model needs ~79.0 GB GPU but only 42.5 GB free (7.1B params)
- recipes/vision/qwen2_vl_2b/dpo/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 4
- recipes/vision/qwen2_vl_2b/sft/full/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 4
- recipes/vision/qwen2_vl_2b/sft/lora/train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 4
- recipes/vision/qwen3_vl_2b/sft/2b_instruct_fft_train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 64
- recipes/vision/qwen3_vl_2b/sft/2b_instruct_lora_train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 64
...
- recipes/vision/qwen3_vl_4b/sft/4b_instruct_lora_train.yaml: **FAILED** — ValueError: Image features and image tokens do not match, tokens: 0, features: 64
- recipes/vision/smolvlm/sft/full/train.yaml: **FAILED** — ValueError: The number of images in the text [0] and images [1] should be the same.
- recipes/vision/smolvlm/sft/lora/train.yaml: **FAILED** — ValueError: The number of images in the text [0] and images [1] should be the same.
